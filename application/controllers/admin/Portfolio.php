	...
	function simpan_portfolio(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	            	if ($this->upload->do_upload('filefoto'))
	            	{
	            		...
	            		$this->m_portfolio->simpan_portfolio($judul,$isi,$user_nama,$gambar, $kategori);
	        ...
	        function update_portfolio(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	            	if ($this->upload->do_upload('filefoto'))
	            	{
	            		...
	            		$user_nama=$p['pengguna_nama'];
	            		$kategori=$this->input->post('xkategori');
	            		$this->m_portfolio->update_portfolio($port_id,$judul,$isi,$user_nama,$gambar, $kategori);
	            	...
	            	$user_nama=$p['pengguna_nama'];
	            	$kategori=$this->input->post('xkategori');
	            	$this->m_portfolio->update_portfolio_tanpa_img($port_id,$judul,$isi,$user_nama, $kategori);
	            	echo $this->session->set_flashdata('msg','info');
	            	redirect('admin/portfolio');
	            } 
